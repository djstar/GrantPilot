...
This section provides detailed ASCII wireframes for all major screens in GrantPilot, including component specifications, interaction patterns, and design notes.

### 11.1 Design System Overview

#### 11.1.1 Layout Structure

```
┌─────────────────────────────────────────────────────────────────────────────────────┐
│                                  GLOBAL HEADER                                       │
│  Logo    |    Navigation    |    Project Selector    |    Notifications    |  User  │
├────────────┬────────────────────────────────────────────────────────────────────────┤
│            │                                                                        │
│   SIDE     │                                                                        │
...
#### 11.1.2 Design Tokens

| Token | Value | Usage |
|-------|-------|-------|
| **Primary Color** | `#2563eb` (Blue 600) | Actions, links, active states |
| **Success Color** | `#16a34a` (Green 600) | Funded grants, high confidence |
| **Warning Color** | `#d97706` (Amber 600) | Deadlines, medium confidence |
| **Error Color** | `#dc2626` (Red 600) | Errors, low confidence, alerts |
...
#### 11.1.4 Component Library (shadcn/ui)
...
- **Progress**: Loading states, completion tracking
- **Tabs**: Mode switching, section navigation
...
The main landing page after login, showing overview of all activity.

```
┌─────────────────────────────────────────────────────────────────────────────────────┐
│ 🧬 GrantPilot                    [Select Project ▾]    🔔 3    ⚙️    👤 Dr. Smith   │
├─────────────────────────────────────────────────────────────────────────────────────┤
│                                                                                     │
│  Welcome back, Dr. Smith                                         Today: Jan 10, 2025│
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────────┐│
│  │ 📊 QUICK STATS                                                                  ││
│  ├─────────────────┬─────────────────┬─────────────────┬───────────────────────────┤│
│  │  Active Grants  │  Upcoming       │  Pending        │  This Month's            ││
│  │  ───────────    │  Deadlines      │  Reviews        │  AI Usage                ││
│  │     4           │     2           │     1           │   $47.23 / $100          ││
│  │  projects       │  in 30 days     │  awaiting       │   ████████░░░ 47%        ││
│  └─────────────────┴─────────────────┴─────────────────┴───────────────────────────┘│
│                                                                                     │
│  ┌────────────────────────────────────────┐  ┌─────────────────────────────────────┐│
│  │ 🔥 PRIORITY ACTIONS                    │  │ 📅 UPCOMING DEADLINES               ││
│  ├────────────────────────────────────────┤  ├─────────────────────────────────────┤│
│  │                                        │  │                                     ││
│  │ ⚠️ R01-Cancer-2025                     │  │ Jan 25  R01-Cancer-2025      15 days││
│  │   Specific Aims needs revision         │  │         └─ Specific Aims due       ││
│  │   [Open in Co-pilot]                   │  │                                     ││
│  │                                        │  │ Feb 05  R21-Pilot-2025       26 days││
│  │ 📋 NIH-RFA-CA-25-003                   │  │         └─ Full submission          ││
│  │   New RFA matches your profile         │  │                                     ││
│  │   [Analyze RFA]                        │  │ Mar 01  K99-Career          50 days ││
│  │                                        │  │         └─ Letter of intent         ││
│  │ 💬 Reviewer feedback available         │  │                                     ││
│  │   R01-Cancer-2024 summary statement    │  │ [View Full Calendar]                ││
│  │   [Process Feedback]                   │  │                                     ││
│  │                                        │  └─────────────────────────────────────┘│
│  └────────────────────────────────────────┘                                         │
│                                                                                     │
...
│  │                                                                                 ││
│  │  ┌──────────────────────┐  ┌──────────────────────┐  ┌──────────────────────┐  ││
│  │  │ R01-Cancer-2025      │  │ R21-Pilot-2025       │  │ K99-Career-2025      │  ││
│  │  │ NIH / R01            │  │ NIH / R21            │  │ NIH / K99            │  ││
│  │  │ ───────────────      │  │ ───────────────      │  │ ───────────────      │  ││
│  │  │ Status: Drafting     │  │ Status: Drafting     │  │ Status: Planning     │  ││
│  │  │ Due: Jan 25, 2025    │  │ Due: Feb 05, 2025    │  │ Due: Mar 01, 2025    │  ││
│  │  │                      │  │                      │  │                      │  ││
...
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────────┐│
│  │ 🤖 RUNNING AGENTS                                               [View All →]   ││
│  ├─────────────────────────────────────────────────────────────────────────────────┤│
│  │                                                                                 ││
│  │  ● Research Agent | R01-Cancer-2025 | "Analyzing competitive landscape..."     ││
│  │    ████████████░░░░░░░░ 62% | Running 14m | Est. 8m remaining                   ││
│  │    [Pause] [View Details] [Inject Context]                                      ││
│  │                                                                                 ││
│  └─────────────────────────────────────────────────────────────────────────────────┘│
│                                                                                     │
├─────────────────────────────────────────────────────────────────────────────────────┤
│ ✓ All systems operational | Last sync: 2 min ago | Next backup: 4:00 PM            │
└─────────────────────────────────────────────────────────────────────────────────────┘
```
...
|-----------|----------|-------|
| Quick Stats Cards | Click to navigate to relevant section | Updates in real-time |
| Priority Actions | Ordered by urgency | Max 5 items shown |
| Deadline Timeline | Shows next 30 days by default | Color-coded by urgency |
| Project Cards | Click to open project | Shows key metrics |
| Running Agents | Live progress updates via WebSocket | Can control from here |

---

### 11.3 Project List View

Full list of all projects with filtering and sorting.
...
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────────┐│
│  │ Filter: [All Types ▾]  [All Status ▾]  [All Funders ▾]    🔍 Search...          ││
│  │                                                                                 ││
│  │ Sort by: [Deadline ▾]  [Ascending ▾]                       Showing 12 projects  ││
│  └─────────────────────────────────────────────────────────────────────────────────┘│
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────────┐│
│  │  □  Name                    │ Type  │ Funder │ Status    │ Deadline    │ Progress│
│  ├─────────────────────────────────────────────────────────────────────────────────┤│
│  │  □  R01-Cancer-2025         │ R01   │ NIH    │ Drafting  │ Jan 25 ⚠️   │ ████░ 78%│
│  │  □  R21-Pilot-2025          │ R21   │ NIH    │ Drafting  │ Feb 05      │ ███░░ 55%│
│  │  □  K99-Career-2025         │ K99   │ NIH    │ Planning  │ Mar 01      │ █░░░░ 15%│
│  │  □  Gates-Global-Health     │ Grant │ Found. │ Submitted │ —           │ █████100%│
│  │  □  R01-Immunology-2024     │ R01   │ NIH    │ Funded ✓  │ —           │ █████100%│
│  │  □  R01-Cancer-2024         │ R01   │ NIH    │ Scored    │ —           │ █████100%│
│  │  □  NSF-CAREER-2024         │ CAREER│ NSF    │ Submitted │ —           │ █████100%│
│  │  □  R21-Methods-2024        │ R21   │ NIH    │ Not Fund  │ —           │ █████100%│
│  │  │                          │       │        │           │             │         ││
│  │  │                          │       │        │           │             │         ││
│  └─────────────────────────────────────────────────────────────────────────────────┘│
│                                                                                     │
│  With selected: [Archive] [Export] [Compare]                                        │
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────────┐│
│  │ 📊 PORTFOLIO SUMMARY                                                            ││
│  ├────────────────────┬────────────────────┬────────────────────┬──────────────────┤│
│  │ Total Projects: 12 │ Active: 4          │ Submitted: 3       │ Success Rate:33% ││
│  │                    │ (drafting/planning)│ (awaiting review)  │ (funded/reviewed)││
│  └────────────────────┴────────────────────┴────────────────────┴──────────────────┘│
│                                                                                     │
└─────────────────────────────────────────────────────────────────────────────────────┘
```
...
| Action | Result |
|--------|--------|
| Click row | Open Project Detail view |
| Click checkbox | Select for bulk actions |
| Click column header | Sort by that column |
| Hover row | Show quick action buttons |
| Right-click row | Context menu (Archive, Duplicate, Export) |
...
### 11.4 Project Detail View

Main workspace for a specific grant project.

```
┌─────────────────────────────────────────────────────────────────────────────────────┐
│ 🧬 GrantPilot                    [R01-Cancer-2025 ▾]   🔔 3    ⚙️    👤 Dr. Smith   │
├─────────────────────────────────────────────────────────────────────────────────────┤
│                                                                                     │
│  ← Back to Projects    R01-Cancer-2025                         [⋮ Actions ▾]       │
│                        NIH R01 | NIH-RFA-CA-25-001 | Due: Jan 25, 2025 (15 days)   │
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────────┐│
│  │  [ 🤖 Agent ]  [ 👤 Co-pilot ]  [ 📝 Review & Learn ]  [ 📊 Overview ]          ││
│  └─────────────────────────────────────────────────────────────────────────────────┘│
│                                                                                     │
│  ┌────────────────────────────────────────┬────────────────────────────────────────┐│
│  │ 📄 DOCUMENTS                           │ 📋 RFA REQUIREMENTS                    ││
│  ├────────────────────────────────────────┤ ──────────────────────                 ││
│  │                                        │                                        ││
│  │ Grant Sections:                        │ Format:                                ││
│  │ ├─ ✓ Specific Aims (v3)               │ ☑ 1-page limit           ✓ 0.95 pages  ││
│  │ ├─ ◐ Significance (v2)                │ ☑ Arial 11pt             ✓ Compliant   ││
│  │ ├─ ◐ Innovation (v1)                  │ ☑ 0.5" margins           ✓ Compliant   ││
│  │ ├─ ○ Approach (not started)           │                                        ││
│  │ └─ ○ Timeline (not started)           │ Content:                               ││
│  │                                        │ ◐ Health disparities     2/5 mentions  ││
│  │ Supporting Documents:                  │ ○ Specific populations   Not found     ││
│  │ ├─ ✓ Biosketch_PI.pdf                 │ ◐ Preliminary data       Partial       ││
│  │ ├─ ✓ Budget_justification.xlsx        │                                        ││
│  │ ├─ ○ Letters of support (0/3)         │ [View Full RFA Analysis]               ││
│  │ └─ ○ Facilities document              │                                        ││
│  │                                        │ ──────────────────────                 ││
│  │ Research Notes:                        │ ⚠️ 3 items need attention              ││
│  │ ├─ Competitive_landscape.md           │ [Run Compliance Check]                 ││
│  │ └─ Prior_awardee_analysis.md          │                                        ││
│  │                                        ├────────────────────────────────────────┤│
│  │ [+ Upload Document]                    │ 💰 PROJECT BUDGET                      ││
│  │                                        │ ──────────────────                     ││
│  ├────────────────────────────────────────┤                                        ││
│  │ 🎯 PROGRESS                            │ AI Usage: $23.45 / $50.00             ││
│  │ ──────────────────                     │ ████████████░░░░░ 47%                  ││
│  │                                        │                                        ││
│  │ Overall: ████████░░ 78%               │ Breakdown:                             ││
│  │                                        │ ├─ Research: $12.30                   ││
│  │ ├─ Specific Aims    █████████ 95%     │ ├─ Writing:  $8.50                    ││
│  │ ├─ Significance     ██████░░░ 70%     │ ├─ Analysis: $2.15                    ││
│  │ ├─ Innovation       ████░░░░░ 45%     │ └─ Other:    $0.50                    ││
│  │ ├─ Approach         ░░░░░░░░░ 0%      │                                        ││
│  │ └─ Supporting       ██████░░░ 65%     │ [Adjust Budget]                        ││
│  │                                        │                                        ││
│  └────────────────────────────────────────┴────────────────────────────────────────┘│
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────────┐│
│  │ 📌 PINNED NOTES                                                     [+ Add]    ││
│  ├─────────────────────────────────────────────────────────────────────────────────┤│
│  │ • Focus on tumor microenvironment angle — reviewer feedback from 2024          ││
│  │ • Include Dr. Chen as collaborator for biomarker expertise                      ││
│  │ • Cite recent Nature paper on CAR-T exhaustion (PMID:38123456)                  ││
│  └─────────────────────────────────────────────────────────────────────────────────┘│
│                                                                                     │
└─────────────────────────────────────────────────────────────────────────────────────┘
```
...
### 11.5 Agent Mode Panel

Full agent mode interface for autonomous task execution.
...
│  │ │ ┌─────────────────────────────────────────────────────────────────────────┐ │ ││
│  │ │ │ Research the competitive landscape for CAR-T therapy grants, analyze    │ │ ││
│  │ │ │ prior NIH R01 awards in this space from 2021-2024, identify gaps in     │ │ ││
│  │ │ │ current research, and draft a 1-page competitive analysis summary.      │ │ ││
│  │ │ └─────────────────────────────────────────────────────────────────────────┘ │ ││
│  │ │                                                                             │ ││
│  │ │ ┌─ Constraints ─────────────────────────────────────────────────────────┐   │ ││
│  │ │ │                                                                       │   │ ││
│  │ │ │  ⏱️ Time limit:  [2 hours    ▾]    🔍 Depth:  [Comprehensive ▾]       │   │ ││
│  │ │ │                                                                       │   │ ││
│  │ │ │  💰 Budget cap:  [$15.00     ]     □ Stop when budget reached         │   │ ││
│  │ │ │                                                                       │   │ ││
│  │ │ └───────────────────────────────────────────────────────────────────────┘   │ ││
│  │ │                                                                             │ ││
│  │ │ ┌─ Source Scope ────────────────────────────────────────────────────────┐   │ ││
│  │ │ │                                                                       │   │ ││
│  │ │ │  ☑ NIH Reporter (prior awards database)                               │   │ ││
│  │ │ │  ☑ PubMed (recent literature)                                         │   │ ││
│  │ │ │  ☑ Web search (general)                                               │   │ ││
│  │ │ │  ☑ My manuscripts (/Dropbox/Papers/2023-2024)                         │   │ ││
│  │ │ │  ☑ This RFA: NIH-RFA-CA-25-001                                        │   │ ││
│  │ │ │  ☐ My prior grants (knowledge base)                                   │   │ ││
│  │ │ │  ☐ Example grants (reference library)                                 │   │ ││
│  │ │ │                                                                       │   │ ││
│  │ │ └───────────────────────────────────────────────────────────────────────┘   │ ││
│  │ │                                                                             │ ││
│  │ │              [▶️ Launch Agent]        [💾 Save as Template]                  │ ││
│  │ │                                                                             │ ││
│  │ └─────────────────────────────────────────────────────────────────────────────┘ ││
│  │                                                                                 ││
│  │ ┌─ AGENT ACTIVITY ────────────────────────────────────────────────────────────┐ ││
...
│  │ │ ════════════════════════════════════════════════════════════════════════    │ ││
│  │ │                                                                             │ ││
│  │ │ 14:23:01  🔍 Research Agent                                                 │ ││
│  │ │           Parsing task requirements and planning search strategy...         │ ││
│  │ │                                                                             │ ││
│  │ │ 14:23:15  🔍 Research Agent                                                 │ ││
│  │ │           Querying NIH Reporter for R01 grants with keywords:               │ ││
│  │ │           "CAR-T", "chimeric antigen receptor", "adoptive cell therapy"     │ ││
│  │ │                                                                             │ ││
│  │ │ 14:24:02  ✓ Research Agent                                                  │ ││
│  │ │           Found 47 R01 grants (2021-2024) | Confidence: ✓ High              │ ││
│  │ │           Top institutions: Stanford, Penn, MD Anderson, Memorial Sloan     │ ││
│  │ │                                                                             │ ││
│  │ │ 14:24:30  🔍 Research Agent                                                 │ ││
│  │ │           Analyzing abstracts for research gaps...                          │ ││
│  │ │           Processing 47 abstracts with SPECTER2 embeddings                  │ ││
│  │ │                                                                             │ ││
│  │ │ 14:25:45  💡 Analysis Agent                                                 │ ││
│  │ │           Identified potential gaps:                                        │ ││
│  │ │           1. Tumor microenvironment resistance (12 grants, declining)       │ ││
│  │ │           2. Solid tumor efficacy (8 grants, growing)                       │ ││
│  │ │           3. Manufacturing scalability (4 grants, underexplored)            │ ││
│  │ │           Confidence: ◐ Medium (based on abstract analysis)                 │ ││
│  │ │                                                                             │ ││
│  │ │ 14:26:10  🔍 Research Agent                                                 │ ││
│  │ │           Searching PubMed for recent reviews on identified gaps...         │ ││
│  │ │           ████████████░░░░░░░░ Processing...                                │ ││
│  │ │                                                                             │ ││
│  │ │ ────────────────────────────────────────────────────────────────────────    │ ││
│  │ │                                                                             │ ││
│  │ │ ┌─ Inject Context ──────────────────────────────────────────────────────┐   │ ││
│  │ │ │                                                                       │   │ ││
│  │ │ │ [Type guidance or upload a document to add mid-run...]         [Send] │   │ ││
│  │ │ │                                                      [📎 Attach File] │   │ ││
│  │ │ └───────────────────────────────────────────────────────────────────────┘   │ ││
│  │ │                                                                             │ ││
│  │ │      [⏸️ Pause]    [🛑 Stop & Save]    [📊 View Interim Results]            │ ││
│  │ │                                                                             │ ││
│  │ └─────────────────────────────────────────────────────────────────────────────┘ ││
│  │                                                                                 ││
│  │ ┌─ STATUS ────────────────────────────────────────────────────────────────────┐ ││
│  │ │ Progress: ████████████░░░░░░░░ 62%  |  Time: 14m / 2h  |  Cost: $3.20/$15  │ ││
│  │ └─────────────────────────────────────────────────────────────────────────────┘ ││
│  │                                                                                 ││
│  └─────────────────────────────────────────────────────────────────────────────────┘│
│                                                                                     │
...
**Agent Activity Log Features:**

| Feature | Description |
|---------|-------------|
| Color-coded icons | 🔍 Searching, ✓ Complete, 💡 Insight, ⚠️ Warning |
| Confidence badges | Shown for all inferences |
...
### 11.6 Co-pilot Mode (Split View)

Interactive collaboration with side-by-side document and chat.
...
│  │ ────────────────────────                 │ ────────────────────                 ││
│  │                                          │                                      ││
│  │ [Specific Aims ▾]  v3  Draft             │  🤖 Co-pilot                         ││
│  │ [Export ▾]  [Version History]  [⚙️]      │  ─────────────                       ││
│  │                                          │  I notice your Aim 2 doesn't        ││
│  │ ┌──────────────────────────────────────┐ │  reference the preliminary data     ││
│  │ │                                      │ │  from your 2024 Nature paper.       ││
│  │ │ SPECIFIC AIMS                        │ │                                      ││
│  │ │                                      │ │  The RFA emphasizes "strong         ││
│  │ │ The long-term goal of this research  │ │  rationale based on prior work" —   ││
│  │ │ is to develop [next-generation      ]│ │  adding Figure 3 data here would    ││
│  │ │ CAR-T therapies that overcome tumor  │ │  strengthen this significantly.     ││
│  │ │ microenvironment resistance.         │ │                                      ││
│  │ │                                      │ │  Confidence: ✓ High                 ││
│  │ │ The objective of this application   │ │  (RFA priority match + your data)   ││
│  │ │ is to [engineer novel CAR constructs│ │                                      ││
│  │ │ with enhanced persistence].         │ │  [Insert Reference] [Show RFA Text] ││
│  │ │                                  💡 │ │                                      ││
│  │ │ Our central hypothesis is that...   │ │  ─────────────────────────────────   ││
│  │ │ ════════════════════════════════════│ │                                      ││
│  │ │                                      │ │  👤 You                              ││
│  │ │ Aim 1: Characterize exhaustion...   │ │  Can you show me how other funded   ││
│  │ │                                      │ │  R01s in this space positioned      ││
│  │ │ Aim 2: Engineer novel CAR designs   │ │  their preliminary data?            ││
│  │ │  ⚠️ [AI: Missing prelim data ref]   │ │                                      ││
│  │ │                                      │ │  ─────────────────────────────────   ││
│  │ │ Aim 3: Validate in preclinical...   │ │                                      ││
│  │ │                                      │ │  🤖 Co-pilot                         ││
│  │ │                                      │ │  I found 5 funded R01s with similar ││
│  │ │                                      │ │  preliminary data sections. Here's  ││
│  │ │                                      │ │  how they structured them:          ││
│  │ │                                      │ │                                      ││
│  │ │                                      │ │  1. Dr. Chen (Penn, 2023)            ││
│  │ │                                      │ │     "In our prior work (Fig 2A),    ││
│  │ │                                      │ │      we demonstrated that..."       ││
│  │ │                                      │ │     [View Full]                      ││
│  │ │                                      │ │                                      ││
│  │ │                                      │ │  2. Dr. Park (Stanford, 2024)        ││
│  │ │                                      │ │     Used sidebar callout boxes      ││
│  │ │                                      │ │     [View Full]                      ││
│  │ │                                      │ │                                      ││
│  │ │                                      │ │  Would you like me to draft a       ││
│  │ │                                      │ │  similar sentence for your Aim 2?   ││
│  │ │                                      │ │                                      ││
│  │ │                                      │ │  [Yes, draft it] [Show more examples]││
│  │ │                                      │ │                                      ││
│  │ └──────────────────────────────────────┘ │  ─────────────────────────────────   ││
│  │                                          │                                      ││
│  │ Page 0.95/1.0 ✓ | Arial 11pt ✓ | 0.5" ✓  │  ┌─────────────────────────────────┐ ││
│  │                                          │  │ Ask me anything...        [Send]│ ││
│  ├──────────────────────────────────────────┤  └─────────────────────────────────┘ ││
│  │ ⚡ QUICK ACTIONS                         │                                      ││
│  │ [Check Compliance] [Style Match] [Cite] │  [📎] [🎤] [/commands]              ││
│  └──────────────────────────────────────────┴──────────────────────────────────────┘│
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────────┐│
│  │ 📊 PROACTIVE ALERTS                                              [Dismiss All] ││
│  │ ⚠️ Deadline: 15 days | 🔍 Style match: 78% ◐ | ⚠️ 2 compliance items need review││
│  └─────────────────────────────────────────────────────────────────────────────────┘│
│                                                                                     │
└─────────────────────────────────────────────────────────────────────────────────────┘
```
...
| Icon | Meaning | Action on Click |
|------|---------|-----------------|
| 💡 | AI suggestion available | Show suggestion popup |
| ⚠️ | Issue detected | Show issue details |
| 📎 | Linked reference | Show reference |
| ✓ | Verified/approved | Show verification source |
| [text] | Editable AI insertion | Edit inline |

**Slash Commands Available:**

| Command | Action |
|---------|--------|
| `/cite` | Insert citation from reference manager |
| `/check` | Run compliance check on selection |
| `/rephrase` | Rephrase selected text |
| `/expand` | Expand/elaborate selected point |
| `/condense` | Shorten selected text |
| `/style` | Check style match on selection |
| `/compare` | Compare with funded grant examples |

---

### 11.7 Document Viewer

Full-screen document viewing with annotation support.
...
├─────────────────────────────────────────────────────────────────────────────────────┤
│                                                                                     │
│  ← Back    📄 Specific_Aims_v3.docx                            [Edit in Co-pilot]  │
│                                                                                     │
│  ┌──────────────────────────────────────────────────────────────────────────┬──────┐│
│  │                                                                          │ 📝   ││
│  │  ┌────────────────────────────────────────────────────────────────────┐  │      ││
│  │  │                                                                    │  │ Anno-││
│  │  │                         SPECIFIC AIMS                              │  │ tation││
│  │  │                                                                    │  │      ││
│  │  │  The long-term goal of this research is to develop next-          │  │ ──── ││
│  │  │  generation CAR-T therapies that overcome tumor microenvironment  │  │      ││
│  │  │  resistance. The objective of this application, which is the      │  │ 💬 3  ││
│  │  │  first step toward attaining our long-term goal, is to engineer   │  │ comments│
│  │  │  novel CAR constructs with enhanced persistence and anti-tumor    │  │      ││
│  │  │  activity in immunosuppressive environments.                      │  │ 🏷️ 2  ││
│  │  │                                                                    │  │ tags  ││
│  │  │  Our central hypothesis is that incorporating exhaustion-         │  │      ││
│  │  │  resistant signaling domains into CAR architecture will           │  │ 📊    ││
│  │  │  significantly improve therapeutic outcomes in solid tumors.      │  │ Style:││
│  │  │  This hypothesis is based on our preliminary studies showing...   │  │ 78%   ││
│  │  │                                                                    │  │      ││
│  │  │  The rationale for this project is that current CAR-T therapies   │  │      ││
│  │  │  show limited efficacy in solid tumors due to...                  │  │      ││
│  │  │                                                                    │  │      ││
│  │  │  ─────────────────────────────────────────────────────────────    │  │      ││
│  │  │                                                                    │  │      ││
│  │  │  Aim 1: Characterize exhaustion markers in CAR-T cells within     │  │      ││
│  │  │         solid tumor microenvironments                             │  │      ││
│  │  │                                                                    │  │      ││
│  │  │  Aim 2: Engineer novel CAR designs incorporating exhaustion-      │  │      ││
│  │  │         resistant elements                                        │  │      ││
│  │  │                                                                    │  │      ││
│  │  │  Aim 3: Validate optimized CAR constructs in preclinical          │  │      ││
...
│  ┌─────────────────────────────────────────────────────────────────────────────────┐│
│  │ TOOLBAR                                                                         ││
│  │ [🔍 Search] [📝 Highlight] [💬 Comment] [🏷️ Tag] [📊 Analyze] [⬇️ Download]    ││
│  └─────────────────────────────────────────────────────────────────────────────────┘│
│                                                                                     │
└─────────────────────────────────────────────────────────────────────────────────────┘
```
...
### 11.8 RFA Analysis View

Deep analysis of a Request for Applications.
...
├─────────────────────────────────────────────────────────────────────────────────────┤
│                                                                                     │
│  📋 RFA Analysis: NIH-RFA-CA-25-001                                                │
│  "Novel Approaches to Enhance CAR-T Cell Therapy Efficacy"                         │
│                                                                                     │
│  ┌───────────────────────────────┬─────────────────────────────────────────────────┐│
│  │ 📊 QUICK FACTS                │ 🎯 AI-INFERRED PRIORITIES                       ││
│  ├───────────────────────────────┤ ────────────────────────────                    ││
│  │                               │                                                 ││
│  │ Funder: NIH/NCI               │ 1. Tumor Microenvironment ✓ High                ││
│  │ Mechanism: R01                │    Mentioned 23 times in RFA                    ││
│  │ Budget: $500K/year direct     │    Your coverage: ████████░░ 78%               ││
│  │ Duration: 5 years             │                                                 ││
│  │                               │ 2. Preliminary Data ✓ High                      ││
│  │ Deadline: Jan 25, 2025        │    "Strong preliminary data expected"           ││
│  │ Receipt: Feb 05, 2025         │    Your coverage: ██████░░░░ 55%               ││
│  │                               │                                                 ││
│  │ Status: Open                  │ 3. Clinical Translation ◐ Medium               ││
│  │ Competition: ~150 expected    │    Implied from "path to clinical"             ││
│  │ Est. Awards: 8-12             │    Your coverage: ████░░░░░░ 40%               ││
│  │ Success Rate: ~8%             │                                                 ││
│  │                               │ 4. Novel Approach ◐ Medium                      ││
│  │ [View Original PDF]           │    Standard R01 criterion                       ││
│  │                               │    Your coverage: ████████░░ 75%               ││
│  │                               │                                                 ││
│  │                               │ [Expand All] [Compare to My Draft]              ││
│  └───────────────────────────────┴─────────────────────────────────────────────────┘│
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────────┐│
│  │ 📝 EXPLICIT REQUIREMENTS                                        □ Hide Met     ││
│  ├─────────────────────────────────────────────────────────────────────────────────┤│
│  │                                                                                 ││
│  │  ✓ Page Limits                                                                  ││
│  │    • Specific Aims: 1 page ✓ (you: 0.95 pages)                                 ││
│  │    • Research Strategy: 12 pages ✓ (you: 10.2 pages)                           ││
│  │    • Biosketch: 5 pages ✓ (you: 4 pages)                                       ││
│  │                                                                                 ││
│  │  ✓ Format Requirements                                                          ││
│  │    • Arial 11pt ✓                                                              ││
│  │    • 0.5 inch margins ✓                                                        ││
│  │    • Single-spaced ✓                                                           ││
│  │                                                                                 ││
│  │  ⚠️ Required Sections (2 of 5 incomplete)                                       ││
│  │    • ✓ Specific Aims                                                           ││
│  │    • ✓ Significance                                                            ││
│  │    • ✓ Innovation                                                              ││
│  │    • ○ Approach (not started)                                                  ││
...
│  │                                                                                 ││
│  │  ⚠️ Required Attachments (3 of 6 missing)                                       ││
│  │    • ✓ Biosketch (PI)                                                          ││
│  │    • ✓ Budget                                                                  ││
│  │    • ✓ Budget Justification                                                    ││
│  │    • ○ Letters of Support (0/3 required)                                       ││
│  │    • ○ Facilities Document                                                     ││
...
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────────┐│
│  │ 🔍 "READING BETWEEN THE LINES"                              Confidence: ◐ Med  ││
│  ├─────────────────────────────────────────────────────────────────────────────────┤│
│  │                                                                                 ││
│  │ Hidden Preferences (inferred from language patterns):                           ││
│  │                                                                                 ││
│  │ • "Investigator track record" emphasized 4x → Strong publication record valued  ││
│  │   Your fit: ✓ High (15 relevant papers in last 3 years)                        ││
│  │                                                                                 ││
│  │ • "Preliminary data" mentioned 8x with "robust" → Need strong pilot data       ││
│  │   Your fit: ◐ Medium (consider adding more quantitative results)               ││
│  │                                                                                 ││
│  │ • "Multi-disciplinary" appears 3x → Collaboration valued                        ││
│  │   Your fit: ○ Low (no collaborators listed yet)                                ││
│  │   Suggestion: Consider adding co-Is with complementary expertise               ││
│  │                                                                                 ││
│  │ [🔬 Research Prior Awardees]  [📊 Analyze Review Criteria]                      ││
│  │                                                                                 ││
│  └─────────────────────────────────────────────────────────────────────────────────┘│
│                                                                                     │
└─────────────────────────────────────────────────────────────────────────────────────┘
...
### 11.9 Compliance Checker View

Real-time compliance monitoring with confidence indicators.
...
├─────────────────────────────────────────────────────────────────────────────────────┤
│                                                                                     │
│  ✅ Compliance Checker                                      Last run: 5 min ago    │
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────────┐│
│  │ OVERALL STATUS                                                [🔄 Run Check]   ││
│  ├─────────────────────────────────────────────────────────────────────────────────┤│
│  │                                                                                 ││
│  │      ┌─────────────────────────────────────────────────────────────────────┐   ││
│  │      │                                                                     │   ││
│  │      │   ████████████████████████░░░░░░░░   78% COMPLIANT                  │   ││
│  │      │                                                                     │   ││
│  │      │   ✓ 18 checks passed   ⚠️ 4 warnings   ✕ 2 failures                │   ││
│  │      │                                                                     │   ││
│  │      └─────────────────────────────────────────────────────────────────────┘   ││
│  │                                                                                 ││
│  └─────────────────────────────────────────────────────────────────────────────────┘│
│                                                                                     │
│  ┌──────────────────────────────────────────┬──────────────────────────────────────┐│
│  │ 📐 FORMAT CHECKS                         │ 📝 CONTENT CHECKS                    ││
│  │ ───────────────                          │ ────────────────                     ││
│  │                                          │                                      ││
│  │ ✓ High Confidence (Exact Measurements)   │ ◐ Medium Confidence (NLP Detection)  ││
│  │                                          │                                      ││
│  │ ✓ Specific Aims: 0.95/1.0 pages         │ ✓ Innovation points covered: 3/3    ││
│  │ ✓ Research Strategy: 10.2/12 pages      │   "novel", "first", "unique"         ││
│  │ ✓ Font: Arial 11pt detected             │                                      ││
│  │ ✓ Margins: 0.5" all sides               │ ◐ Significance keywords: 4/6        ││
│  │ ✓ Line spacing: Single                  │   Found: "burden", "impact",         ││
│  │                                          │          "morbidity", "mortality"    ││
│  │ ✓ Biosketch: 4/5 pages                  │   Missing: "disparities", "equity"   ││
│  │ ✓ References: Numbered format           │   [See RFA context]                  ││
│  │                                          │                                      ││
│  │                                          │ ⚠️ Preliminary data references: 2    ││
│  │                                          │   RFA emphasizes "robust" data       ││
│  │                                          │   Recommendation: Add more figures   ││
│  │                                          │                                      ││
│  │                                          │ ○ Timeline present: Not found        ││
│  │                                          │   Low confidence — may be embedded   ││
│  │                                          │   [Mark as addressed]                ││
│  │                                          │                                      ││
│  └──────────────────────────────────────────┴──────────────────────────────────────┘│
│                                                                                     │
...
│  │   • Letters of Support: 0 of 3 required                                         ││
│  │     [Upload Letters]                                                            ││
│  │                                                                                 ││
│  │ ✕ Resource Sharing Plan                                                         ││
│  │   • Required for awards >$500K/year                                             ││
│  │     [Generate Template] [Upload Document]                                       ││
│  │                                                                                 ││
│  └─────────────────────────────────────────────────────────────────────────────────┘│
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────────┐│
│  │ 🤖 ANTI-LLM DETECTION                                        Mode: Balanced    ││
│  ├─────────────────────────────────────────────────────────────────────────────────┤│
│  │                                                                                 ││
│  │ Flagged Phrases (3 found):                                                      ││
│  │                                                                                 ││
│  │ ✓ "It's important to note that..." (Specific Aims, line 14)                    ││
│  │   Confidence: ✓ High (known AI pattern)                                        ││
│  │   [Rephrase] [Keep] [Add to allowlist]                                         ││
│  │                                                                                 ││
│  │ ◐ "multifaceted approach" (Significance, line 32)                              ││
│  │   Confidence: ◐ Medium (common in scientific writing)                          ││
│  │   [Rephrase] [Keep] [Add to allowlist]                                         ││
│  │                                                                                 ││
│  │ ◐ "In conclusion, this research..." (Approach, line 245)                       ││
│  │   Confidence: ◐ Medium (acceptable in conclusions)                             ││
│  │   [Rephrase] [Keep] [Add to allowlist]                                         ││
│  │                                                                                 ││
│  │ Overall AI-Detection Risk: LOW ✓                                               ││
│  │ [Run Full Analysis] [Adjust Sensitivity]                                        ││
│  │                                                                                 ││
│  └─────────────────────────────────────────────────────────────────────────────────┘│
│                                                                                     │
└─────────────────────────────────────────────────────────────────────────────────────┘
...
### 11.10 Knowledge Base Manager

Central hub for all ingested documents and institutional memory.

```
┌─────────────────────────────────────────────────────────────────────────────────────┐
│ 🧬 GrantPilot                    [Knowledge Base]      🔔 3    ⚙️    👤 Dr. Smith   │
├─────────────────────────────────────────────────────────────────────────────────────┤
│                                                                                     │
│  📚 Knowledge Base                                              [+ Add Documents]  │
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────────┐│
│  │ 🔍 Search knowledge base...                    [All Types ▾] [All Sources ▾]   ││
│  └─────────────────────────────────────────────────────────────────────────────────┘│
│                                                                                     │
│  ┌───────────────────────┬─────────────────────────────────────────────────────────┐│
...
│  │                       │                                                         ││
│  │ 📝 My Papers (23)     │ ┌───────────────────────────────────────────────────┐   ││
│  │   └─ Published (18)   │ │ 📄 CAR-T_exhaustion_Nature2024.pdf                │   ││
│  │   └─ Preprints (3)    │ │    Type: Published Paper | Added: Jan 2024        │   ││
│  │   └─ Drafts (2)       │ │    Citations: 47 | In projects: R01-Cancer-2025   │   ││
│  │                       │ │    Embeddings: ✓ SPECTER2, ✓ PubMedBERT           │   ││
│  │ 📋 Grant Examples (12)│ │    [View] [Edit Tags] [Remove]                    │   ││
│  │   └─ Funded (8) ⭐     │ └───────────────────────────────────────────────────┘   ││
│  │   └─ Unfunded (4)     │                                                         ││
│  │                       │ ┌───────────────────────────────────────────────────┐   ││
│  │ 💬 Reviewer Feedback  │ │ 📄 R01_funded_example_Penn.pdf                     │   ││
│  │    (6)                │ │    Type: Funded Grant | Funder: NIH               │   ││
│  │                       │ │    Score: 18 | Funded: 2023                       │   ││
│  │ 📋 RFAs (15)          │ │    Weight: 2.0x (funded grant bonus)              │   ││
│  │   └─ Active (4)       │ │    Style learning: ✓ Included in corpus           │   ││
│  │   └─ Archived (11)    │ │    [View] [Edit Tags] [Adjust Weight]             │   ││
│  │                       │ └───────────────────────────────────────────────────┘   ││
│  │ ✍️ Style Corpus (14)   │                                                         ││
│  │                       │ ┌───────────────────────────────────────────────────┐   ││
│  │ 🔬 Research Notes (8) │ │ 📄 Summary_Statement_R01_2024.pdf                  │   ││
│  │                       │ │    Type: Reviewer Feedback | Project: R01-Cancer   │   ││
│  │ 📎 Reference Library  │ │    Overall Score: 32 | Status: Not Funded         │   ││
│  │    (156 refs)         │ │    Parsed: ✓ Strengths (3), Weaknesses (5)        │   ││
│  │                       │ │    [View] [View Analysis] [Link to Project]       │   ││
│  │                       │ └───────────────────────────────────────────────────┘   ││
│  │ [+ Add Category]      │                                                         ││
│  │                       │ Showing 3 of 78 documents                [Load More]   ││
│  └───────────────────────┴─────────────────────────────────────────────────────────┘│
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────────┐│
│  │ 📂 FOLDER WATCHING                                                              ││
...
│  │ Active Watchers:                                                                ││
│  │                                                                                 ││
│  │ ✓ /Users/smith/Dropbox/Grants/            Last scan: 2 min ago                  ││
│  │   47 documents | 12 projects detected     [Scan Now] [Configure]               ││
│  │                                                                                 ││
│  │ ✓ /Users/smith/Dropbox/Papers/            Last scan: 15 min ago                 ││
│  │   23 manuscripts detected                  [Scan Now] [Configure]               ││
│  │                                                                                 ││
│  │ [+ Add Watched Folder]                                                          ││
│  │                                                                                 ││
│  └─────────────────────────────────────────────────────────────────────────────────┘│
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────────┐│
│  │ ✍️ STYLE LEARNING STATUS                                                        ││
│  ├─────────────────────────────────────────────────────────────────────────────────┤│
│  │                                                                                 ││
│  │ Corpus Size: 14 documents (78,432 words)           Tier: ✓ CONFIDENT            ││
│  │ ████████████████████░░░░ 14/10 minimum                                          ││
│  │                                                                                 ││
│  │ Weighted Sources:                                                               ││
│  │ • Funded grants (5): 2.0x weight                                                ││
│  │ • Recent papers (6): 1.0x weight                                                ││
│  │ • Older papers (3): 0.5x weight                                                 ││
│  │                                                                                 ││
│  │ [View Style Profile] [Adjust Weights] [Add Documents]                           ││
│  │                                                                                 ││
│  └─────────────────────────────────────────────────────────────────────────────────┘│
│                                                                                     │
└─────────────────────────────────────────────────────────────────────────────────────┘
...
### 11.11 Settings & Configuration

System configuration and preferences.

```
┌─────────────────────────────────────────────────────────────────────────────────────┐
│ 🧬 GrantPilot                    [Settings]            🔔 3    ⚙️    👤 Dr. Smith   │
├─────────────────────────────────────────────────────────────────────────────────────┤
│                                                                                     │
│  ⚙️ Settings                                                                        │
│                                                                                     │
...
│  │                       │ ─────────────                                           ││
│  │ 🔑 API Keys           │                                                         ││
│  │ 🤖 LLM Preferences    │ Anthropic API Key                                       ││
│  │ 💰 Budget & Limits    │ ┌─────────────────────────────────────────────────────┐ ││
│  │ 👤 User Profile       │ │ sk-ant-•••••••••••••••••••••••••••••••••••          │ ││
│  │ 📁 Folder Watching    │ └─────────────────────────────────────────────────────┘ ││
│  │ ✍️ Style Learning      │ Status: ✓ Valid | Last verified: Today                 ││
│  │ 🔔 Notifications      │ [Test Connection] [Update Key]                          ││
│  │ 💾 Backup & Sync      │                                                         ││
│  │ 🎨 Appearance         │ OpenAI API Key                                          ││
│  │ 🔧 Advanced           │ ┌─────────────────────────────────────────────────────┐ ││
│  │                       │ │ sk-•••••••••••••••••••••••••••••••••••••••••••••••• │ ││
│  │                       │ └─────────────────────────────────────────────────────┘ ││
│  │                       │ Status: ✓ Valid                                         ││
...
│  │                       │ Status: ✓ Valid                                         ││
│  │                       │                                                         ││
│  │                       │ ⚠️ API keys are encrypted at rest using AES-256-GCM     ││
│  │                       │                                                         ││
│  └───────────────────────┴─────────────────────────────────────────────────────────┘│
│                                                                                     │
└─────────────────────────────────────────────────────────────────────────────────────┘
...
│  │                       │ ──────────────────                                      ││
│  │ 🔑 API Keys           │                                                         ││
│  │ 🤖 LLM Preferences ●  │ Primary Model                                           ││
│  │ 💰 Budget & Limits    │ ┌─────────────────────────────────────────────────────┐ ││
│  │ 👤 User Profile       │ │ Claude 3.5 Sonnet                              ▾    │ ││
│  │ 📁 Folder Watching    │ └─────────────────────────────────────────────────────┘ ││
│  │ ✍️ Style Learning      │ Used for: Main writing, analysis, compliance           ││
│  │ 🔔 Notifications      │                                                         ││
│  │ 💾 Backup & Sync      │ Fast Model (for simple tasks)                           ││
│  │ 🎨 Appearance         │ ┌─────────────────────────────────────────────────────┐ ││
│  │ 🔧 Advanced           │ │ Claude 3.5 Haiku                               ▾    │ ││
│  │                       │ └─────────────────────────────────────────────────────┘ ││
│  │                       │ Used for: Classification, simple queries                ││
│  │                       │                                                         ││
│  │                       │ Offline Fallback                                        ││
│  │                       │ ┌─────────────────────────────────────────────────────┐ ││
│  │                       │ │ BioMistral 2 (Ollama)                          ▾    │ ││
│  │                       │ └─────────────────────────────────────────────────────┘ ││
│  │                       │ Status: ✓ Available (model downloaded)                  ││
│  │                       │                                                         ││
│  │                       │ Image Generation                                        ││
│  │                       │ ○ Nano Banana API (Recommended)                         ││
│  │                       │ ○ DALL-E 3                                              ││
│  │                       │ ○ Disabled                                              ││
│  │                       │                                                         ││
│  │                       │ Temperature Settings                                    ││
│  │                       │ Writing tasks:   [0.7] ─────●───── Creative             ││
│  │                       │ Analysis tasks:  [0.3] ──●──────── Precise              ││
│  │                       │ Research tasks:  [0.5] ────●────── Balanced             ││
│  │                       │                                                         ││
│  └───────────────────────┴─────────────────────────────────────────────────────────┘│
└─────────────────────────────────────────────────────────────────────────────────────┘
```
...
│  │                       │ ──────────────────                                      ││
│  │ 🔑 API Keys           │                                                         ││
│  │ 🤖 LLM Preferences    │ Global Monthly Budget                                   ││
│  │ 💰 Budget & Limits ●  │ ┌─────────────────────────────────────────────────────┐ ││
│  │ 👤 User Profile       │ │ $100.00                                        USD  │ ││
│  │ 📁 Folder Watching    │ └─────────────────────────────────────────────────────┘ ││
│  │ ✍️ Style Learning      │ Current usage: $47.23 (47%)                             ││
│  │ 🔔 Notifications      │ ████████████████░░░░░░░░░░░░░░░░                        ││
│  │ 💾 Backup & Sync      │ Resets: Feb 1, 2025                                     ││
│  │ 🎨 Appearance         │                                                         ││
│  │ 🔧 Advanced           │ Default Per-Project Budget                              ││
│  │                       │ ┌─────────────────────────────────────────────────────┐ ││
│  │                       │ │ $50.00                                         USD  │ ││
│  │                       │ └─────────────────────────────────────────────────────┘ ││
│  │                       │                                                         ││
...
│  │                       │ ● Soft limit (complete current task, block new)         ││
...
│  │                       │ ☑ Auto-save checkpoints every 15 min                   ││
│  │                       │                                                         ││
│  └───────────────────────┴─────────────────────────────────────────────────────────┘│
└─────────────────────────────────────────────────────────────────────────────────────┘
```
...
### 11.12 Cost Tracking Dashboard

Detailed view of AI usage and costs.

```
┌─────────────────────────────────────────────────────────────────────────────────────┐
│ 🧬 GrantPilot                    [Cost Tracking]       🔔 3    ⚙️    👤 Dr. Smith   │
├─────────────────────────────────────────────────────────────────────────────────────┤
│                                                                                     │
│  💰 Cost Tracking                                        Period: [January 2025 ▾]  │
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────────┐│
│  │ MONTHLY OVERVIEW                                                                ││
│  ├─────────────────────────────────────────────────────────────────────────────────┤│
│  │                                                                                 ││
│  │   Total Spend        Budget           Remaining          Projected             ││
│  │   ───────────        ──────           ─────────          ─────────             ││
│  │   $47.23             $100.00          $52.77             $68.50                ││
│  │                                                                                 ││
│  │   ████████████████████████░░░░░░░░░░░░░░░░░░░░░  47% used                       ││
│  │                                                                                 ││
│  └─────────────────────────────────────────────────────────────────────────────────┘│
│                                                                                     │
│  ┌──────────────────────────────────────────┬──────────────────────────────────────┐│
│  │ 📊 SPEND BY PROJECT                      │ 📈 DAILY USAGE                       ││
│  ├──────────────────────────────────────────┤ ──────────────────                   ││
│  │                                          │                                      ││
│  │ R01-Cancer-2025        $23.45   49.7%   │          ┌─┐                         ││
│  │ ████████████████████░░░░░░░░░░           │        ┌─┤ │   ┌─┐                   ││
│  │ Budget: $50 | Remaining: $26.55          │      ┌─┤ │ │ ┌─┤ │                   ││
│  │                                          │    ┌─┤ │ │ │ │ │ │ ┌─┐             ││
│  │ R21-Pilot-2025         $12.30   26.0%   │  ┌─┤ │ │ │ │ │ │ │ │ │ │ │         ││
│  │ ██████████░░░░░░░░░░░░░░░░░░░░           │  │ │ │ │ │ │ │ │ │ │ │ │ │ │       ││
│  │ Budget: $30 | Remaining: $17.70          │  ─────────────────────────           ││
│  │                                          │  1  3  5  7  9  11 13 15 ...         ││
│  │ K99-Career-2025        $8.15    17.3%   │  January 2025                         ││
│  │ ███████░░░░░░░░░░░░░░░░░░░░░░░           │                                      ││
│  │ Budget: $25 | Remaining: $16.85          │ Avg daily: $3.15                     ││
│  │                                          │ Peak day: $8.42 (Jan 7)              ││
│  │ Other projects         $3.33    7.0%    │                                      ││
│  │ ███░░░░░░░░░░░░░░░░░░░░░░░░░░░           │                                      ││
│  │                                          │                                      ││
│  └──────────────────────────────────────────┴──────────────────────────────────────┘│
│                                                                                     │
...
│  ├─────────────────────────────────────────────────────────────────────────────────┤│
│  │                                                                                 ││
│  │  Research Agent    $18.50   39.2%   ████████████████░░░░░░░░░░░░░░░░░░░░       ││
│  │  Writing Agent     $15.23   32.2%   █████████████░░░░░░░░░░░░░░░░░░░░░░░       ││
│  │  Analysis Agent    $8.15    17.3%   ███████░░░░░░░░░░░░░░░░░░░░░░░░░░░░░       ││
│  │  Compliance Agent  $3.20    6.8%    ███░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░       ││
│  │  Creative Agent    $1.50    3.2%    █░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░       ││
│  │  Learning Agent    $0.65    1.4%    █░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░       ││
│  │                                                                                 ││
│  └─────────────────────────────────────────────────────────────────────────────────┘│
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────────┐│
...
│  ├─────────────────────────────────────────────────────────────────────────────────┤│
│  │                                                                                 ││
│  │  Time          Project           Agent       Tokens    Cost     Task           ││
│  │  ─────────────────────────────────────────────────────────────────────────────  ││
│  │  14:30         R01-Cancer-2025   Research    45,230    $1.35    Comp. landscape││
│  │  14:15         R01-Cancer-2025   Analysis    12,450    $0.37    Gap analysis   ││
│  │  13:45         R21-Pilot-2025    Writing     28,100    $0.84    Significance   ││
│  │  12:30         R01-Cancer-2025   Compliance  8,200     $0.25    Format check   ││
│  │  11:15         K99-Career-2025   Research    52,400    $1.57    Prior awardees ││
│  │  ...                                                                            ││
│  │                                                                                 ││
│  │  Showing 5 of 156 transactions                                    [View All]   ││
│  │                                                                                 ││
│  └─────────────────────────────────────────────────────────────────────────────────┘│
│                                                                                     │
└─────────────────────────────────────────────────────────────────────────────────────┘
...
### 11.13 Review & Learn Mode

Feedback ingestion and pattern discovery interface.
...
│  │  ┌─ SUBMISSION TRACKER ──────────────────────────────────────────────────────┐  ││
│  │  │                                                                           │  ││
│  │  │  Grant              Submitted   Outcome      Score  Iteration  Feedback   │  ││
│  │  │  ────────────────────────────────────────────────────────────────────────  │  ││
│  │  │  R01-Cancer-2025    —           Drafting     —      1st        —          │  ││
│  │  │  R01-Cancer-2024    Mar 2024    Not Funded   32     2nd        ✓ Parsed   │  ││
│  │  │  R01-Cancer-2023    Mar 2023    Not Funded   38     1st        ✓ Parsed   │  ││
│  │  │  R21-Pilot-2024     Jun 2024    Funded ⭐    18     1st        ✓ Parsed   │  ││
│  │  │  K99-Career-2023    Oct 2023    Funded ⭐    22     2nd        ✓ Parsed   │  ││
│  │  │  R01-Immunology-23  Mar 2023    Funded ⭐    15     1st        ✓ Parsed   │  ││
│  │  │                                                                           │  ││
│  │  │  [+ Add Submission]  [Upload Summary Statement]                           │  ││
│  │  │                                                                           │  ││
│  │  └───────────────────────────────────────────────────────────────────────────┘  ││
│  │                                                                                 ││
│  └─────────────────────────────────────────────────────────────────────────────────┘│
│                                                                                     │
│  ┌──────────────────────────────────────────┬──────────────────────────────────────┐│
│  │ 🔍 PARSED FEEDBACK                       │ 💡 AI-DISCOVERED PATTERNS            ││
│  │ R01-Cancer-2024 Summary Statement        │ ────────────────────────             ││
│  ├──────────────────────────────────────────┤                                      ││
│  │                                          │ From your 6 submissions:             ││
│  │ Overall Impact Score: 32                 │                                      ││
│  │                                          │ ✓ STRENGTHS (Consistent)             ││
│  │ ┌─ Strengths ─────────────────────────┐  │ • Innovation sections score well     ││
│  │ │                                     │  │   (avg percentile: 15)               ││
│  │ │ • "Innovative approach to CAR-T     │  │ • Strong publication record noted    ││
│  │ │    engineering" (3 reviewers)       │  │   in all reviews                     ││
│  │ │                                     │  │ • Expertise in tumor microenv.       ││
│  │ │ • "Strong preliminary data for      │  │   recognized                         ││
│  │ │    Aim 1" (2 reviewers)             │  │                                      ││
│  │ │                                     │  │ ⚠️ WEAKNESSES (Recurring)            ││
│  │ │ • "PI has excellent track record"   │  │ • Feasibility concerns in 4/6        ││
│  │ │   (3 reviewers)                     │  │   → Add more timeline detail         ││
│  │ │                                     │  │   → Include pilot data for Aim 2     ││
│  │ └─────────────────────────────────────┘  │                                      ││
│  │                                          │ • Statistical power questions 3/6    ││
│  │ ┌─ Weaknesses ────────────────────────┐  │   → Add power calculations           ││
│  │ │                                     │  │   → Justify sample sizes             ││
│  │ │ • "Timeline for Aim 2 seems        │  │                                      ││
│  │ │    ambitious" (2 reviewers)         │  │ • Approach clarity in 2/6            ││
│  │ │   Actionable: Add milestones       │  │   → Use more subheadings              ││
│  │ │                                     │  │   → Add workflow diagrams            ││
│  │ │ • "Preliminary data for Aim 2      │  │                                      ││
│  │ │    is limited" (3 reviewers)        │  │ ──────────────────────────────       ││
│  │ │   Actionable: Add Fig 4 data       │  │                                      ││
│  │ │                                     │  │ 📊 SUCCESS PREDICTION                ││
│  │ │ • "Sample size justification       │  │ Current draft: 35% → 42%             ││
│  │ │    unclear" (1 reviewer)            │  │ If addressing top 3 issues: ~55%    ││
│  │ │   Actionable: Add power calc       │  │                                      ││
│  │ │                                     │  │ [View Full Analysis]                 ││
│  │ └─────────────────────────────────────┘  │ [Compare Iterations]                 ││
│  │                                          │ [Generate Improvement Plan]          ││
│  │ [View Original] [Link to Draft]          │                                      ││
│  └──────────────────────────────────────────┴──────────────────────────────────────┘│
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────────┐│
│  │ 📈 IMPROVEMENT TRACKING: R01-Cancer (2023 → 2024 → 2025)                        ││
│  ├─────────────────────────────────────────────────────────────────────────────────┤│
│  │                                                                                 ││
│  │              2023 (Score: 38)    2024 (Score: 32)    2025 (Current)             ││
│  │              ──────────────      ──────────────      ──────────────             ││
│  │ Innovation   ████████░░ 80%      █████████░ 90%      █████████░ 92%  ↑         ││
│  │ Significance ██████░░░░ 60%      ███████░░░ 70%      ████████░░ 78%  ↑         ││
│  │ Approach     ████░░░░░░ 40%      ██████░░░░ 55%      ███████░░░ 68%  ↑         ││
│  │ Feasibility  ███░░░░░░░ 30%      █████░░░░░ 48%      ██████░░░░ 55%  ↑         ││
│  │ Environment  ████████░░ 78%      ████████░░ 82%      █████████░ 85%  ↑         ││
│  │                                                                                 ││
│  │ Overall trajectory: ↑ Improving | Predicted score: 25-28                       ││
│  │                                                                                 ││
│  └─────────────────────────────────────────────────────────────────────────────────┘│
│                                                                                     │
└─────────────────────────────────────────────────────────────────────────────────────┘
...
### 11.14 Sync Conflict Resolution Dialog

Modal for handling sync conflicts (from Appendix D).
...
│        ├──────────────────────────────────────────────────────────────────┤        │
│        │                                                                  │        │
│        │  File: Specific_Aims_v3.docx                                     │        │
│        │  Project: R01-Cancer-2025                                        │        │
│        │                                                                  │        │
│        │  ┌────────────────────────┬────────────────────────┐             │        │
│        │  │ LOCAL VERSION          │ REMOTE VERSION         │             │        │
│        │  ├────────────────────────┼────────────────────────┤             │        │
│        │  │                        │                        │             │        │
│        │  │ Modified: 10:30 AM     │ Modified: 10:45 AM     │             │        │
│        │  │ By: GrantPilot         │ By: External Edit      │             │        │
│        │  │                        │                        │             │        │
│        │  │ Changes:               │ Changes:               │             │        │
│        │  │ • Added Aim 2 prelim   │ • Fixed typo line 12   │             │        │
│        │  │   data reference       │ • Updated PI name      │             │        │
│        │  │ • Rephrased central    │                        │             │        │
│        │  │   hypothesis           │                        │             │        │
│        │  │                        │                        │             │        │
│        │  │ [View Full]            │ [View Full]            │             │        │
...
│        │  ● Merge both (recommended) — keeps all changes                  │        │
...
### 11.15 Style Profile Display

Visualization of learned writing style.

```
┌─────────────────────────────────────────────────────────────────────────────────────┐
│ 🧬 GrantPilot                    [Style Profile]       🔔 3    ⚙️    👤 Dr. Smith   │
├─────────────────────────────────────────────────────────────────────────────────────┤
│                                                                                     │
│  ✍️ Your Writing Style Profile                           Tier: ✓ CONFIDENT         │
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────────┐│
│  │ 📊 STYLE METRICS                                                                ││
│  ├─────────────────────────────────────────────────────────────────────────────────┤│
│  │                                                                                 ││
│  │  Corpus: 14 documents | 78,432 words | 5 funded grants included                 ││
│  │  Confidence: ████████████████████░░░░ 87% (14/10 min documents)                ││
│  │                                                                                 ││
│  │  ┌─ Vocabulary Profile ───────────────────────────────────────────────────┐    ││
│  │  │                                                                        │    ││
│  │  │  Technical depth:    ████████████████░░░░ High                         │    ││
│  │  │  Jargon frequency:   ██████████░░░░░░░░░░ Moderate                     │    ││
│  │  │  Sentence length:    ████████████░░░░░░░░ Medium-long (avg 24 words)   │    ││
│  │  │  Passive voice:      ████░░░░░░░░░░░░░░░░ Low (12% of sentences)       │    ││
│  │  │                                                                        │    ││
│  │  └────────────────────────────────────────────────────────────────────────┘    ││
│  │                                                                                 ││
...
│  │  │                                                                        │    ││
│  │  │  Frequently used:                                                      │    ││
│  │  │  • "We hypothesize that..." (23 occurrences)                          │    ││
│  │  │  • "Our preliminary data demonstrate..." (18 occurrences)              │    ││
│  │  │  • "Building on our prior work..." (12 occurrences)                   │    ││
│  │  │  • "This approach is innovative because..." (9 occurrences)            │    ││
│  │  │                                                                        │    ││
│  │  │  Avoided patterns:                                                     │    ││
│  │  │  • "It is important to note..." (0 occurrences — good, AI pattern)     │    ││
│  │  │  • "In conclusion..." (2 occurrences — sometimes used)                 │    ││
│  │  │                                                                        │    ││
│  │  └────────────────────────────────────────────────────────────────────────┘    ││
│  │                                                                                 ││
│  └─────────────────────────────────────────────────────────────────────────────────┘│
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────────┐│
│  │ 📚 STYLE CORPUS                                                [+ Add More]    ││
│  ├─────────────────────────────────────────────────────────────────────────────────┤│
│  │                                                                                 ││
│  │  Document                           Type            Weight    Contribution     ││
│  │  ─────────────────────────────────────────────────────────────────────────────  ││
│  │  R01_Immunology_2023_funded.docx    Funded Grant    2.0x      ████████ 18%    ││
│  │  R21_Pilot_2024_funded.docx         Funded Grant    2.0x      ███████░ 15%    ││
│  │  K99_Career_2023_funded.docx        Funded Grant    2.0x      ███████░ 14%    ││
│  │  CAR-T_Nature_2024.pdf              Paper           1.0x      █████░░░ 10%    ││
│  │  Significance_example.docx          Funded Grant    2.0x      █████░░░ 10%    ││
│  │  Review_JCI_2024.pdf                Paper           1.0x      ████░░░░ 8%     ││
│  │  ...                                                                            ││
│  │                                                                                 ││
│  │  [Adjust Weights]  [Remove Selected]  [Recalculate Profile]                    ││
│  │                                                                                 ││
│  └─────────────────────────────────────────────────────────────────────────────────┘│
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────────┐│
│  │ 🎯 STYLE MATCH EXAMPLES                                                         ││
│  ├─────────────────────────────────────────────────────────────────────────────────┤│
│  │                                                                                 ││
│  │  Original (your style):                                                         ││
│  │  "Our preliminary data demonstrate that CAR-T cells exhibit rapid exhaustion    ││
│  │   within solid tumor microenvironments, suggesting that novel engineering       ││
│  │   approaches are needed to maintain therapeutic efficacy."                      ││
│  │                                                                                 ││
│  │  AI-generated (before style matching):                                          ││
│  │  "It's important to note that CAR-T cells experience exhaustion in tumors.     ││
│  │   This multifaceted challenge requires innovative solutions."                   ││
│  │   ⚠️ Style match: 34%                                                          ││
│  │                                                                                 ││
│  │  AI-generated (after style matching):                                           ││
│  │  "We observe that CAR-T cells undergo rapid functional decline within the      ││
│  │   immunosuppressive tumor microenvironment, indicating that enhanced CAR        ││
│  │   designs may be required for sustained anti-tumor activity."                   ││
│  │   ✓ Style match: 89%                                                           ││
│  │                                                                                 ││
│  └─────────────────────────────────────────────────────────────────────────────────┘│
│                                                                                     │
...
### 11.16 Component Specifications

#### 11.16.1 Navigation Components

| Component | Description | States |
|-----------|-------------|--------|
| **Header** | Fixed top bar with logo, nav, notifications | Default, Notifications open |
| **Project Selector** | Dropdown for switching projects | Closed, Open, Loading |
| **Mode Tabs** | Agent/Co-pilot/Review & Learn toggle | Active, Inactive, Disabled |
| **Sidebar** | Context-sensitive left panel | Expanded, Collapsed |

#### 11.16.2 Interactive Components

| Component | Description | Interactions |
|-----------|-------------|--------------|
| **Agent Activity Log** | Real-time task progress | Auto-scroll, Expand entries, Click to details |
| **Document Editor** | Rich text with AI annotations | Inline editing, Accept/Reject suggestions |
| **Chat Panel** | Co-pilot conversation | Send message, Quick actions, File attach |
| **Compliance Badges** | Pass/Warn/Fail indicators | Hover for details, Click to fix |
| **Confidence Indicators** | ✓ ◐ ○ icons | Hover for explanation |

#### 11.16.3 Form Components

| Component | Validation | Notes |
|-----------|------------|-------|
| **API Key Input** | Format validation, test connection | Masked display, copy protection |
| **Budget Input** | Numeric, min 0, max 10000 | Currency formatting |
| **Time Limit Dropdown** | Predefined options + custom | 30m, 1h, 2h, 4h, Custom |
| **Source Checkboxes** | At least one required | Grouped by category |
| **Mission Textarea** | Min 20 chars, max 2000 | Character count shown |

---

### 11.17 Responsive Design Notes

GrantPilot is designed for **desktop-only** use (laptop/monitor), but should handle common viewport sizes gracefully.
...
| **Small Desktop** | 768-1023px | Collapsible sidebar, reduced margins |

#### 11.17.2 Minimum Requirements

- **Minimum width:** 1024px (warning shown below this)
- **Minimum height:** 768px
- **Target resolution:** 1440×900 and above

---

### 11.18 Accessibility Considerations
